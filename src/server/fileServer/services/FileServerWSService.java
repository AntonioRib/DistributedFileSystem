 ...
 * 
 */
@WebServiceClient(name = "FileServerWSService", targetNamespace = "http://fileServer.server/", wsdlLocation = "http://10.22.133.189/sd?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILESERVERWSSERVICE_QNAME = new QName("http://fileServer.server/", "FileServerWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.22.133.189/sd?wsdl");
    ...
    public FileServerWS getFileServerWSPort() {
        return super.getPort(new QName("http://fileServer.server/", "FileServerWSPort"), FileServerWS.class);
    }
    ...
    public FileServerWS getFileServerWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://fileServer.server/", "FileServerWSPort"), FileServerWS.class, features);
    }
